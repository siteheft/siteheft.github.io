...
document.querySelector("input[name=sh-section3-phone-location-input]").addEventListener("change", () => {
    var locationValue = document.querySelector("input[name=sh-section3-phone-location-input]").value;
  ...
  url: "/cdn-cgi/trace"
    ...
    for (var index = 0; index < supportNumbers.length; index ++) {
        if(supportNumbers[index].code == locale) {
            ...
            document.querySelector("input[sh-section3-phone-location-input]").value = "sg";
